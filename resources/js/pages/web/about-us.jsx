        ...
        <div className="max-w-7xl mx-auto break-words space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-sm text-justify">
                        To provide customized training services in the fields of
                        Management, Marketing, Finance, Accounting, Real Estate,
                        Environmental Planning, Production Planning, Data
                        Analysis, and Data Interpretation, Academic and Business
                        Research, Hospitality consultancy, and Training
                        services. To empower the firms and workers in their
                        respective fields and to enhance their potentials that
                        add value to their endeavors and businesses.
                    </p>
                </div>
            </div>
        </div>
