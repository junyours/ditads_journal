export default function AimScope() {
    return (
        <div className="text-justify text-sm">
            ...
            <br />
            <p>
                It features a wide range of content, including inspiring stories
                and personal experiences of local and international
                professionals from various fields and industries, as well as
                expert opinions on pressing societal issues. The magazine also
                publishes poems and essays on education, research, life, and
                other disciplines, along with feature articles highlighting
