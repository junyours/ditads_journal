        ...
        <div className="container mx-auto p-4 flex gap-4 max-lg:flex-col-reverse">
            ...
            <div className="h-fit w-full border sm:flex lg:max-w-96 lg:flex-col">
                ...
                <p className="text-justify p-4 text-sm">
                    ...
                    Public Administration (DIT.ADS JEBMPA) is firmly committed
                    to advancing the United Nations’ Sustainable Development
                    Goals, with a focused alignment on SDG 8 (Decent Work and
                    Economic Growth), SDG 9 (Industry, Innovation and
                    Infrastructure), SDG 12 (Responsible Consumption and
                    Production), and SDG 17 (Partnership for the Goals). The
                    journal serves as a platform for research that promotes
                    inclusive economic development, fosters innovation,
                    advocates for sustainable business and consumption
                    practices, and strengthens collaborative governance. Through
                    this commitment, DIT.ADS JEBMPA empowers scholars,
                    practitioners, and policymakers to generate knowledge that
                    drives progress toward a more resilient, sustainable, and
